...
public class UserManagementControllerClientSideTests extends AbstractTestNGSpringContextTests {
    ...
    public void loginRoot_success() {
        LoginRequest loginRequest = new LoginRequest("root@gmail.com", "123456");
        ...
        assertNotNull(loginResponse.getValidity());
    ...
    public void createUserWithDefaultRole_success() {
        ...
        UserRequest userRequest = new UserRequest("johndoe@gmail.com", testPassword,"John", "Doe",  null);
    ...
    public void createUserWithAdminRole_failByNoAdminCredentials() {
        ...
        UserRequest userRequest = new UserRequest("janedoe@gmail.com", "qwerty", "Jane", "Doe",  List.of(adminRole.getId()));
    ...
    public void createUserWithAdminRole_success() {
        ...
        UserRequest userRequest = new UserRequest("kathdoe@gmail.com", "qwerty", "Kath", "Doe", List.of(adminRole.getId()));
    ...
    public void createUser_failByEmailDuplicity() {
        UserRequest userRequest = new UserRequest("root@gmail.com", "qwerty", "Root2 First Name", "Root2 Last Name", null);
    ...
    public void editUserWithUserCredentials_success() {
        ...
        UserRequest userEditRequest = new UserRequest("annadoe@gmail.com", testPassword, "Anna", "Doe", null);
    ...
    public void editUserWithUserCredentials_failByWrongId() {
        LoginRequest loginEditRequest = new LoginRequest(this.userCreatedWithDefaultRole.getEmail(), this.userCreatedWithDefaultRolePassword);
        UserRequest userEditRequest = new UserRequest("miadoe@gmail.com", "asdfg", "Mia", "Doe", null);
    ...
    public void editUserToAdminWithUserCredentials_failByNoAdminCredentials() {
        ...
        LoginRequest loginEditRequest = new LoginRequest(this.userCreatedWithDefaultRole.getEmail(), this.userCreatedWithDefaultRolePassword);
        UserRequest userEditRequest = new UserRequest("bethdoe@gmail.com", "poiuy", "Beth", "Doe", List.of(adminRole.getId()));
    ...
    public void editUser_failByNoUserCredentials() {
        UserRequest userEditRequest = new UserRequest("annadoe@gmail.com", "12345", "Anna", "Doe", null);
    ...
    public void editUserWithAdminCredentials_success() {
        ...
        UserRequest userEditRequest = new UserRequest("sarahdoe@gmail.com", testPassword, "Sarah", "Doe", null);
